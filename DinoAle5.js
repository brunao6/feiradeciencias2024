...
function update() {
    ...
    if (gameOver) {
        ...
        context.fillText("Precione R para recomeçar", 190, 150);
        return;
    }
    ...
    else if (score > 4500 && velocityX == -18)
    {    
       velocityX -= 1 
    }
    else if (score > 5000 && velocityX == -19)
    {    
       velocityX -= 1 
    }
}
...
function placeCactus() {
    ...
    if (placeCactusChance > .60) { //30% chance para cactus3
        cactus.img = cactus3Img;
        cactus.width = cactus3Width;
        cactusArray.push(cactus);
    }
    else if (placeCactusChance > .40) { //50% chance para cactus2
        cactus.img = cactus2Img;
        cactus.width = cactus2Width;
        cactusArray.push(cactus);
    }
    else if (placeCactusChance > .20) { //80% chance para cactus1
